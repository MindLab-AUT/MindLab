...
function renderPI(pi) {
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow-xl overflow-hidden md:flex border border-gray-200 dark:border-gray-700">
        <div class="md:flex-shrink-0">
            <img class="w-full h-48 object-cover md:w-64 md:h-auto md:aspect-square" src="${pi.imageUrl}" alt="${pi.name}" onerror="this.src='https://placehold.co/400x400/93C5FD/1F2937?text=PI+Photo';">
        </div>
